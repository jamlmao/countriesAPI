<template>
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            <ion-header collapse="condense" style="text-align:center; ">
                <ion-toolbar>
            ...
            <ion-card>
                ...
                <ion-card-header>
                    <ion-card-title style="text-align:center; ">Faroe Island Universities </ion-card-title>
                    <img :src="'https://flagsapi.com/FO/shiny/64.png'" style="width:90px; height:100px; margin:auto">
                </ion-card-header>
...
onMounted(() => {
    axios.get("http://universities.hipolabs.com/search?country=Faroe%20Islands").then((response) => {
