    ...
    <ion-page>
        ...
        <ion-content :fullscreen="true">
            ...
            <ion-card>
                ...
                <ion-card-header>
                    <ion-card-title style="text-align:center; ">Cyprus Universities </ion-card-title>
                    <img :src="'https://flagsapi.com/CY/shiny/64.png'" style="width:90px; height:100px; margin:auto">
                </ion-card-header>
...
onMounted(() => {
    axios.get("http://universities.hipolabs.com/search?country=cyprus").then((response) => {
